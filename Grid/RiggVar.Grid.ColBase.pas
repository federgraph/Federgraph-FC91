...
type
  ...
  protected
    class procedure QuickSort(const List: TObjectList<TBaseObject>; Lo, Hi: Integer; Compare: TBaseObjectCompare);
  public
    class function DefaultCompare(const A, B: TBaseObject): Integer;
    class procedure Sort(const List: TObjectList<TBaseObject>; Compare: TBaseObjectCompare = nil);
  end;
...
begin
  inherited Create;
  FList := TObjectList<TBaseObject>.Create(inOwnsObjects);
end;
...
class procedure TBaseObjectSort.QuickSort(const List: TObjectList<TBaseObject>; Lo,
...
class procedure TBaseObjectSort.Sort(const List: TObjectList<TBaseObject>; Compare: TBaseObjectCompare);
begin
