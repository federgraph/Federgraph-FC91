...
type
  ...
  private
    ...
    function GetCaption(ACol: Integer): string;
    procedure SetCaption(ACol: Integer; const Value: string);
  ...
  public
    ...
    property HeaderRowIndex: Integer read FHeaderRowIndex;
...
procedure TSimpleGridControl.SetColumnIndex(const Value: Integer);
begin
  FColumnIndex := Value;
end;
...
function TSimpleGridControl.GetCaption(ACol: Integer): string;
var
  cp: TBaseColProp;
begin
...
procedure TSimpleGridControl.SetCaption(ACol: Integer; const Value: string);
var
  cp: TBaseColProp;
begin
  cp := ColGrid.ColsActive[ACol];
